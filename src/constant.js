...
export const DOCS_LINK = 'https://docs.niobswap.finance';
export const TWITTER_LINK = 'https://twitter.com/NiobSwap';
export const AUDIT_LINK = 'https://docs.niobswap.finance/audit/';
