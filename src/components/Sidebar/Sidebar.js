...
import { NIOB_BUSD_LP, AUDIT, DOCS, INSURANCE_FUND, LOTTERY, NIOB_SHARING, PREDICTION_TRAINING, TRADING_FEE_CASHBACK } from "../../assets/tokens";
      ...
      {/* {props.showSocial ? (
        ...
        <SidebarFooter className="sidebar_footer">
          ...
          <ul className="social_links">
            ...
            <li>
              <a href="https://t.me/NiobExchange" target="_blank">
                <img src={Telegram} />
              </a>
            </li>
          </ul>
